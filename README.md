...
A personal French/Dutch/Spanish writing practice app. Type on the left, get live grammar corrections with word-level diffs on the right. Highlight any text for AI-powered vocabulary, explanations, and phrase recommendations.
...
- **FR / NL / ES toggle** — switch between French, Dutch, and Spanish; clears the editor for a fresh start
